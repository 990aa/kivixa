...
void main() {
  group('File write stream:', () {
    ...
    test('broadcastFileWrite', () async {
      ...
      FileManager.broadcastFileWrite(FileOperationType.write, '/test.kvx');
    ...
    test('system directory watch', () async {
      ...
      final file = File('$rootDir/test.kvx');
      ...
      final actualPath = events.last.filePath.replaceAll('\\', '/');
      expect(
      ...
      final actualDeletePath = events.last.filePath.replaceAll('\\', '/');
      expect(
        actualDeletePath.endsWith(expectedPath),
        isTrue,
      ); // without the extension
