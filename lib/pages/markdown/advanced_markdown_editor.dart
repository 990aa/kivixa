...
class _AdvancedMarkdownEditorState extends State<AdvancedMarkdownEditor>
  ...
  Future<void> _saveFile() async {
    ...
    try {
      await FileManager.writeFile(
        _currentFilePath!,
        _codeController.text.codeUnits,
        awaitWrite: true,
      );
  ...
  void _formatText(_FormatType type) {
    ...
    _codeController.text = text.replaceRange(start, end, newText);
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () {
              ...
              final markdown = '[$linkText]($url)';

              final text = _codeController.text;
              final start = selection.start;
              final end = selection.end;

              _codeController.text = text.replaceRange(start, end, markdown);
  ...
  Widget _buildEditor(bool isDark) {
    ...
    _codeController.theme = isDark ? vs2015Theme : githubTheme;
