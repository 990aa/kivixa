            ...
            Widget _buildCustomChainsTab(BuildContext context) {
              ...
              return ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Build fully custom timer chains. Add, edit, insert between steps, or remove any timer block.',
                    style: theme.textTheme.bodyMedium?.copyWith(
                      color: colorScheme.onSurfaceVariant,
                    ),
                  ),
                  ...
                  if (customRoutines.isEmpty)
                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Text(
                          'No custom chains yet. Tap + to create your first chain.',
                  ...
                  ...customRoutines.map((routine) {
                    return Card(
                      ...
                      child: ListTile(
                        leading: Icon(routine.icon, color: routine.color),
