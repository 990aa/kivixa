...
Future<CalculusResult> symbolicDifferentiate({
  ...
  required String variable,
  required int order,
}) => MathRustLib.instance.api.crateApiSymbolicDifferentiate(
  expression: expression,
  variable: variable,
  order: order,
);
...
Future<List<CalculusResult>> symbolicGradient({
  required String expression,
  required List<String> variables,
}) => MathRustLib.instance.api.crateApiSymbolicGradient(
  expression: expression,
  variables: variables,
);
...
Future<CalculusResult> symbolicIntegrate({
  required String expression,
  required List<String> variables,
}) => MathRustLib.instance.api.crateApiSymbolicIntegrate(
  expression: expression,
  variables: variables,
);
...
Future<HypothesisTestResult> fTest({
  ...
  required List<double> data2,
  required double alpha,
}) => MathRustLib.instance.api.crateApiFTest(
  data1: data1,
  data2: data2,
  alpha: alpha,
);
...
Future<HypothesisTestResult> mannWhitneyU({
  ...
  required List<double> data2,
  required double alpha,
}) => MathRustLib.instance.api.crateApiMannWhitneyU(
  data1: data1,
  data2: data2,
  alpha: alpha,
);
...
Future<HypothesisTestResult> binomialTest({
  ...
  required double alpha,
}) => MathRustLib.instance.api.crateApiBinomialTest(
  successes: successes,
  trials: trials,
  expectedP: expectedP,
  alpha: alpha,
...
}) => MathRustLib.instance.api.crateApiDurbinWatsonTest(residuals: residuals);
...
Future<List<String>> generateClassicalSequence({
  ...
  required int n,
  required BigInt s,
}) => MathRustLib.instance.api.crateApiGenerateClassicalSequence(
  seqType: seqType,
  a: a,
  dOrR: dOrR,
  n: n,
...
Future<List<String>> generateNumberTheoreticSequence({
  required String seqType,
  required int n,
}) => MathRustLib.instance.api.crateApiGenerateNumberTheoreticSequence(
  seqType: seqType,
  n: n,
);
...
Future<List<String>> generateCombinatorialSequence({
  required String seqType,
  required int n,
}) => MathRustLib.instance.api.crateApiGenerateCombinatorialSequence(
  seqType: seqType,
  n: n,
);
...
Future<Float64List> generateAnalyticalSequence({
  required String seqType,
  required int n,
}) => MathRustLib.instance.api.crateApiGenerateAnalyticalSequence(
  seqType: seqType,
  n: n,
);
