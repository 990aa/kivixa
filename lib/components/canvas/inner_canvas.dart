...
import 'package:kivixa/components/canvas/_canvas_painter.dart';
  ...
  DefaultStyles _getQuillStyles({required bool invert}) {
    ...
    return DefaultStyles(
      ...
      inlineCode: InlineCodeStyle(
        ...
        //
        // I set [InlineCodeStyle.style.backgroundColor] to make it readable,
        // but this isn't perfect: see test/kvx_examples/v9_quill.kvx.dark.png
        // for the issue.
        //
        ...
        style: textTheme.bodyLarge!.copyWith(
          fontFamily: 'FiraMono',
          fontFamilyFallback: kivixaMonoFontFallbacks,
