...
import 'package:kivixa/components/canvas/_circle_stroke.dart';
import 'package:kivixa/components/canvas/_rectangle_stroke.dart';
import 'package:kivixa/data/editor/page.dart';
import 'package:kivixa/data/extensions/list_extensions.dart';
import 'package:kivixa/data/extensions/point_extensions.dart';
...
class Stroke {
  ...
  List<Offset> getPolygon(int N) {
    ...
    if (rememberSimulatedPressure) {
      // Ensure I don't simulate pressure again
      options.simulatePressure = false;
  ...
  static List<PointVector> skipPoints(List<PointVector> points, int N) {
    ...
    // If I have too few points, skip less points
