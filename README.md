# Kivixa gh-pages (F-Droid Repo)

This branch hosts the generated F-Droid repository for Kivixa.

- Public repository URL: https://990aa.github.io/kivixa/repo
- App ID: com.a990aa.kivixa
- Branch purpose: publish signed APK index and metadata for F-Droid clients

Do not commit source-code files to this branch. Keep only repository and metadata assets required for publishing.
<div align="center">
