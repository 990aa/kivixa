...
### 4. Calculus Engine
A powerful numerical calculus suite capable of handling complex multivariable expressions.
- **Differentiation:**
...
- **Hypothesis Testing:** One/Two-Sample T-Tests, Z-Tests, ANOVA, Chi-Squared.
